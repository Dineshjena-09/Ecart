                        ...
                        <div class="panel-body">
                            <form method="POST" action="signup_submit.php">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" pattern=".{6,}" name="password">
                                </div>
                                 <div class="form-group">
                                    <label for="cnfpassword">Confirm Password</label>
                                    <input type="password" class="form-control" id="cnfpassword" pattern=".{6,}" name="cnfpassword">
                                </div>
                                 <div class="form-group">
